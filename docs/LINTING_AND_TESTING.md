...
1. **Cache dependencies**: Use npm cache in CI
2. **Parallel jobs**: Run linting, formatting, and tests in parallel
3. **Incremental builds**: Only build changed files when possible
