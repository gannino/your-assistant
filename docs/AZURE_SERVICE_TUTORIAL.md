...
![1_create_resource](./imgs/azure_speech/1_create_resource.png)

3. Create a `Speech`  resource:

![2_search_speech_service](./imgs/azure_speech/2_search_speech_service.png)

![3_create_speech](./imgs/azure_speech/3_create_speech.png)

4. Fill out the form: 

![4_base_info](./imgs/azure_speech/4_base_info.png)
...
![8_review_create](./imgs/azure_speech/8_review_create.png)



6. Click resource name to view the detail:

![9_info](./imgs/azure_speech/9_info.png)



7. Copy the **KEY 1** and **Location/Region** to Your Assistant :

![10_get_keys](./imgs/azure_speech/10_get_keys.png)