...
- **On Push to `main` after Release PR merge**:
  - All quality checks and tests
  - Build Electron apps for all platforms
  - **Upload platform installers** to GitHub Release created by Release Please
...
release (on push to main after builds complete):
  - Download all platform artifacts
  - Find latest release tag
  - Upload installers to existing GitHub Release
...
3. **Merge**: Merge release PR → Release Please creates GitHub Release
4. **Artifacts**: CI/CD builds and uploads installers to the release
